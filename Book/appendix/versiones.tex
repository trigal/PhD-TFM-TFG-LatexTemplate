...
\item Mayo 2015:
  \begin{itemize}
  \item Se simplificó el flujo de trabajo para empezar a escribir directamente
    sobre los ficheros principales de capítulos y apéndices, evitando
    acciones de reseteo automáticas sobre el contenido.
  \end{itemize}
