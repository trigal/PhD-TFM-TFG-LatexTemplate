...
\item Mayo 2015:
  \begin{itemize}
  \item Se consolidó el contenido de los capítulos en un único fichero
    \texttt{chapters/main.tex}, eliminando los flujos de trabajo legacy
    \texttt{bare} y \texttt{orig}.
  \end{itemize}
